...
namespace ShoppingBird.Desktop.Translations {
    ...
    internal class GlobalStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to No item selected to add to the cart!.
        /// </summary>
        internal static string CartView_NoItemSelected {
            get {
                return ResourceManager.GetString("CartView_NoItemSelected", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to No store/shop is selected, please select a store first..
        /// </summary>
        internal static string CartView_NoStoreSelected {
            get {
                return ResourceManager.GetString("CartView_NoStoreSelected", resourceCulture);
            }
        }
    }
}
